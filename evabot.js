...
const keyboards = {
  ...
  manic:[
    ['🟥 Маникюр с однородным покрытием с гелиевым укреплением','🟧 Снятие без покрытия(Маникюр)'],
  ...
  pedikure:[
    ...
    ['🟡 Педикюр с покрытием пальцев без обработки стопы','🟢 Снятие без покрытия(Педикюр)'],
    ['❌ Вернуться назад']
  ],
